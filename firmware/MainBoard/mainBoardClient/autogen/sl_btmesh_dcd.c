...
const uint8_t __mesh_dcd[] = {
  U16TOA(0x022e), /* Company ID */
  U16TOA(0x0004), /* Product ID */
  U16TOA(0x0301), /* Version Number */
  U16TOA(SL_BTMESH_CONFIG_RPL_SIZE), /* Capacity of Replay Protection List */
  U16TOA(SL_BTMESH_FEATURE_BITMASK), /* Features Bitmask */
  /* Main */
    U16TOA(0x0001), /* Location */
    0x05, /* Number of SIG Models = 5 */
    0x00, /* Number of Vendor Models = 0 */
    /* SIG Models */
      U16TOA(0x0000), /* Configuration Server */
      U16TOA(0x1001), /* Generic OnOff Client */
      U16TOA(0x1003), /* Generic Level Client */
